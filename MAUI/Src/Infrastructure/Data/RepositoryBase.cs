...
namespace Infrastructure.Data
{
       ...
       where TContext : DbContext
    {
        ...
        public async Task CreateAsync(TEntity entity) => await Context.Set<TEntity>().AddAsync(entity);
        ...
        public async Task BulkUpdateAsync(IEnumerable<TEntity> entities) => await Context.BulkUpdateAsync(entities);
        public async Task BulkInsertAsync(IEnumerable<TEntity> entities) => await Context.BulkInsertAsync(entities);
        public async Task BulkDeletetAsync(IEnumerable<TEntity> entities) => await Context.BulkDeleteAsync(entities);
